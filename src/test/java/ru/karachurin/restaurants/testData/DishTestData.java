...
import static ru.karachurin.restaurants.testData.RestaurantTestData.RESTAURANT2;
...
public class DishTestData {
    ...
    public static final Dish DISH4 = new Dish(DISH1_ID + 3, "Steak", 170.30).setRestaurant(RESTAURANT2);
